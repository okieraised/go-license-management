...
import (
	...
	"go-license-management/internal/services/v1/entitlements/repository"
...
func (svc *EntitlementService) Create(ctx *gin.Context, input *models.EntitlementRegistrationInput) (*response.BaseOutput, error) {
	...
	if exists {
		resp.Code = cerrors.ErrCodeMapper[cerrors.ErrEntitlementCodeAlreadyExist]
		resp.Message = cerrors.ErrMessageMapper[cerrors.ErrEntitlementCodeAlreadyExist]
		return resp, cerrors.ErrEntitlementCodeAlreadyExist
	}
