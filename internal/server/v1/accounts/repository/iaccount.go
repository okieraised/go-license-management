...
type IAccount interface {
	...
	UpdateAccountByPK(ctx context.Context, account *entities.Account) (*entities.Account, error)
	...
	CheckAccountEmailExistByPK(ctx context.Context, tenantName, email string) (bool, error)
